...
*   Local Data & Media Export:
    ...
    Users complete forms on their mobile devices, store entries locally, and export the raw data (CSV) and media files directly from the Epicollect5 mobile app to their local file system or cloud storage of choice.
